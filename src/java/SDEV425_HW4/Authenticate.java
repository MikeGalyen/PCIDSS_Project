...
public class Authenticate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isValid) {
            // Create a session object if it is already not  created and limit inactivity to 30 seconds.
            ...
            request.setAttribute("ErrorMessage", "Invalid Username or Password. Try again or contact Mike.");
    ...
    public boolean validate(String name, String pass) {
        ...
        try {
            ...
            if (user_id > 0) {                
                ...
                pstmt2.setString(1, String.valueOf(this.user_id));
